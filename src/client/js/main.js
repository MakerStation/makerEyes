...
//accellerationsRx[0].subscribe(x => console.log("accelleration " + x['object'], x['accelleration'], x['accellerationVector']));eventsRx.subscribe(function(x) { console.log("broadcast", x); });
positionsRx.map(p => p.subscribe(x => console.log("position " + x['object'], x)));
